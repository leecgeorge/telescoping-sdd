...
3. Do the work to satisfy the acceptance criteria — make the failing tests pass (**green**) and then **refactor**, or produce the config / page / infra / doc / skill artifact
